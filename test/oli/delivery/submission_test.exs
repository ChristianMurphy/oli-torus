defmodule Oli.Delivery.AttemptsSubmissionTest do
  ...
  describe "resetting an activity" do
    ...
    test "processing a submission", %{ activity: %{ revision: activity_revision }, page: %{ revision: page_revision }, user1: user,
      ...
      {:ok, {attempt_state, _}} = Attempts.reset_activity(section.context_id, activity_attempt.attempt_guid, token_generator)
      ...
      assert {:error, {:no_more_attempts}} == Attempts.reset_activity(section.context_id, attempt_state.attemptGuid, token_generator)
    ...
    test "handling concurrent reset attempts", %{ part1_attempt1: part_attempt, section: section, activity_attempt1: activity_attempt} do
      ...
      assert {:error, {:no_more_attempts}} == Attempts.reset_activity(section.context_id, activity_attempt.attempt_guid, token_generator)
