...
if [ ! -f .devmode ]; then
  ...
  sed -i '' 's/DATABASE_URL=/# DATABASE_URL=/g' oli.env
  printf "\n\n## CONFIG GENERATED BY DEVMODE ##\nDATABASE_URL=ecto://postgres:changeme@localhost/oli\n##\n" >> oli.env
...
ALIASES="alias dc=docker-compose; alias reload-config='set -a;source oli.env;';"
