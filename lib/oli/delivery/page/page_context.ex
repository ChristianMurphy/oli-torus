defmodule Oli.Delivery.Page.PageContext do
  ...
  to a renderer.
  """
  @spec create_page_context(String.t, String.t, Oli.Accounts.User, any) :: %PageContext{}
  def create_page_context(context_id, page_slug, user, token_generator, container_id \\ nil) do
